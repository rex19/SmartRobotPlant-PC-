...
class ChinaMap extends React.Component {
    ...
    chinaMapAjaxData = async (province) => {
        // try {
        if (province == 'ChongQing') {
            console.log('ChongQing'),
                TodayAllRobotsOutputs = 9000,
                TodayAllRobotsRunningRatio = 79.5,
            ...
            console.log('ShangHai'),
                ...
                TodayAllRobotsRunningRatio = 65.5,
                TodayAllPlantSafetyDays = 108
            ...
            // // console.log('AjaxTodayRobotAlarmsDistributionResponse', AjaxTodayRobotAlarmsDistributionResponse)
        ...
        // } catch (error) {
        //     console.log('ChinaMap.js/chinaMapAjaxData/ajax:', error)
        // }
