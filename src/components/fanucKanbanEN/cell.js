...
const cell1Options = [{ key: '1', icon: 'computer', text: 'ZDT', value: 'cell11' }, { key: '2', icon: 'pie graph', text: 'CellState', value: 'cell12' }]
const cell2Options = [{ key: '1', icon: 'computer', text: 'ZDT', value: 'cell21' }, { key: '2', icon: 'pie graph', text: 'CellState', value: 'cell22' }]
const cell3Options = [{ key: '1', icon: 'computer', text: 'ZDT', value: 'cell31' }, { key: '2', icon: 'pie graph', text: 'CellState', value: 'cell32' }]
const cell4Options = [{ key: '1', icon: 'computer', text: 'ZDT', value: 'cell41' }, { key: '2', icon: 'pie graph', text: 'CellState', value: 'cell42' }]
const cell5Options = [{ key: '1', icon: 'computer', text: 'ZDT', value: 'cell51' }, { key: '2', icon: 'pie graph', text: 'CellState', value: 'cell52' }]
const cell6Options = [{ key: '1', icon: 'computer', text: 'ZDT', value: 'cell61' }, { key: '2', icon: 'pie graph', text: 'CellState', value: 'cell62' }]
const cell7Options = [{ key: '1', icon: 'computer', text: 'ZDT', value: 'cell71' }, { key: '2', icon: 'pie graph', text: 'CellState', value: 'cell72' }]
...
class Cell extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <div>
        <Affix style={{ position: 'absolute', top: '29%', left: '77.2%' }}>
          <Button.Group color={this.props.Cell1State} className='buttonGroup'>
            <Dropdown text='SMART ROBOFEEDER Handling'  //不锈钢焊接单元
          ...
          <Form.Field style={{ display: this.props.HideLabel }}>
            <Label basic pointing className='animated bounceInDown CellLabel' >
              ...
              <p>CellYield：{this.props.Cell1Output || 0 + '件'}
                <Badge status="success" text="Completion Rate  98%" />
                <Badge status="error" text="Equipment Running Rate 30%" /></p>
              <Badge status="success" text="Percent Of Pass 98%" />
              <Badge status="warning" text="Downtime Rate 80%" />
              <Badge status="success" text="Safety 98Days" />
            </Label>
          </Form.Field>
        </Affix>

        <Affix style={{ position: 'absolute', top: '41%', left: '77.2%' }}>
          <Button.Group color={this.props.Cell2State} className='buttonGroup' >
            <Dropdown text='ISD  Sealing System'  //激光跟踪焊接展示单元
          ...
          <Form.Field style={{ display: this.props.HideLabel }}>
            <Label basic pointing className='animated bounceInDown CellLabel'>
              <p>CellYield：{this.props.Cell2Output || 0 + '件'}<Badge status="success" text="Completion Rate  90%" />
                <Badge status="error" text="Equipment Running Rate 30%" /></p>
              <Badge status="success" text="Percent Of Pass 98%" />
              <Badge status="warning" text="Downtime Rate 80%" />
              <Badge status="success" text="Safety 98Days" />
        ...
        <Affix style={{ position: 'absolute', top: '53%', left: '77.2%' }}>
          <Button.Group color={this.props.Cell3State} className='buttonGroup'>
            <Dropdown text='Automotive Body Spot Welding'  //智能焊接铣削打磨系统
          ...
          <Form.Field style={{ display: this.props.HideLabel }}>
            <Label basic pointing className='animated bounceInDown CellLabel'>
              <p>CellYield：{this.props.Cell3Output || 0 + '件'}<Badge status="success" text="Completion Rate  98%" />
                <Badge status="error" text="Equipment Running Rate 30%" /></p>
              <Badge status="success" text="Percent Of Pass 98%" />
              <Badge status="warning" text="Downtime Rate 80%" />
              <Badge status="success" text="Safety 98Days" />
        ...
        <Affix style={{ position: 'absolute', top: '65%', left: '77.2%' }}>
          <Button.Group color={this.props.Cell4State} className='buttonGroup'>
            <Dropdown text='Stainless Steel Arc Welding System' //碳钢焊接单元
          ...
          <Form.Field style={{ display: this.props.HideLabel }}>
            <Label basic pointing className='animated bounceInDown CellLabel'>
              <p>CellYield：{this.props.Cell4Output || 0 + '件'}<Badge status="success" text="Completion Rate  98%" />
                <Badge status="error" text="Equipment Running Rate 30%" /></p>
              <Badge status="success" text="Percent Of Pass 98%" />
              <Badge status="warning" text="Downtime Rate 80%" />
              <Badge status="success" text="Safety 98Days" />
        ...
        <Affix style={{ position: 'absolute', top: '77%', left: '77.2%' }}>
          <Button.Group color={this.props.Cell5State} className='buttonGroup'>
            <Dropdown text='Alumi alloy push-pull wire welding'//碳钢焊接单元
          ...
          <Form.Field style={{ display: this.props.HideLabel }}>
            <Label basic pointing className='animated bounceInDown CellLabel'>
              <p>CellYield：{this.props.Cell5Output || 0 + '件'}<Badge status="success" text="Completion Rate  98%" />
                <Badge status="error" text="Equipment Running Rate 30%" /></p>
              <Badge status="success" text="Percent Of Pass 98%" />
              <Badge status="warning" text="Downtime Rate 80%" />
              <Badge status="success" text="Safety 98Days" />
        ...
        <Modal size={size} open={open1} onClose={this.ZdtModalClose} closeIcon='close' basic>
          ...
          <Modal.Content>
            <iframe src={ZDTsrc} width="100%" height="600px">
              ...
              Your browser does not support iframe. Please upgrade your browser
                        </iframe>
          </Modal.Content>
          <Modal.Actions>
