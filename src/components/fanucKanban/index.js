    ...
    componentWillMount = async () => {
        ...
        if (CurrentFaultRobotsResponseArray.length === 0) {
            ...
            arr2 = CurrentFaultRobotsResponseArray.map(function (item, index, input) {
                return <div><Segment inverted color='red' secondary> {item} 故障中 </Segment></div>;
            })
        }
        this.setState({
        ...
        return (
            <div >
                ...
                <Affix style={{ position: 'absolute', top: '0.3%', right: '43%' }}>
                    <div style={{ margin: '3%', width: '300px' }} onMouseOver={()=>console.log('yesyesyes')}>
                        <a style={{ color: 'black', fontWeight: 'bolder', fontSize: 26, marginLeft: '40%' }}>车间</a>
                    </div>
                ...
                {/*左边每个颜色的注释*/}
                <Affix style={{ position: 'absolute', bottom: '35%', left: '3%' }}>
                    <div>
                        <Badge status="success" text="运行中" />
                        <br />
                        <Badge status="error" text="故障中" />
                        <br />
                        <Badge status="default" text="停机中" />
                        <br />
                ...
                {/*Label标签*/}
                <Affix style={{ position: 'absolute', top: '3.1%', left: '8%' }}>
                    ...
                    <Modal.Content>
                        <Grid>
                            <Grid.Row >
                                <Grid.Column width={16}>
                                    <Form onSubmit={this.handleSubmit}>
                                        <a style={{ width: '10%', fontSize: '1.6rem', color: 'black', marginRight: '1%' }}>序列号:</a>
                                        <Input placeholder='请输入要查询的序列号...' style={{ width: '40%' }} onChange={this.handleChange1} />
                                        {/*<Input placeholder='焊缝号...' style={{ width: '30%' }} onChange={this.handleChange2} />*/}
                                        <Button style={{ marginLeft: '<1%></1%>' }} circular icon='search' />
                                        {/*<Button.Group floated='right'>
                                            <Label size='big'  >
                                                评分：
                                        </Label>
                                            <Rating disabled maxRating={3} defaultRating={this.state.CellhandleSearchRes.QualityGrade || 0} icon='star' size='massive' style={{ floated: 'right' }} />
                                            <br /> //
                                        </Button.Group>*/}
                                    </Form>
                                </Grid.Column>
                            ...
                            <Grid.Row >
                                ...
                                <Grid.Column width={4}>
                                    <a style={{ width: '10%', fontSize: '1.3rem', color: 'black', marginRight: '5%' }}>焊缝号:</a>
                                    <Dropdown placeholder='请选择焊缝号' search selection options={this.state.Part_NumberOptions} style={{ width: '80%', marginBottom: '10px' }} onChange={this.handlePassNoChange} />
